...
const steps = [
  {
    ...
    icon: <User className="w-6 sm:w-8 h-6 sm:h-8 text-slate-600" />,
    bgColor: "bg-teal-600",
  ...
  },
  {
    ...
    icon: <Briefcase className="w-6 sm:w-8 h-6 sm:h-8 text-slate-600" />,
  ...
  },
  {
    ...
    icon: <Users className="w-6 sm:w-8 h-6 sm:h-8 text-slate-600" />,
    bgColor: "bg-teal-600",
  ...
  },
  {
    ...
    icon: <CheckCircle className="w-6 sm:w-8 h-6 sm:h-8 text-slate-600" />,
    bgColor: "bg-slate-500",
    width: "w-full",
  },
];
